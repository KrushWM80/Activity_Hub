# Hosting Platforms & Requirements - Decision Guide

**Created:** February 17, 2026  
**Purpose:** Guide stakeholders through hosting platform options, constraints, and decision-making  
**Audience:** Project managers, architects, technical leads, budget owners

---

## CONTEXT

You are choosing the right hosting platform for your data applications and services. After assessment, you understand *what* to build. Now you need to decide *where* to host it.

Users may have preferences but need guidance on:
- What each platform can/cannot do
- Timeline implications
- Approval requirements  
- Alternative options if their first choice has barriers

**Key Decision Point:** Hosting platform selection affects cost, timeline, scalability, and approval requirements more than technical architecture alone.
...
**Your Assessment Context:** If your assessment shows "Static content only" with no data connections, Code Puppy Pages is appropriate.
...
**Your Assessment Context:** If your assessment shows analytics-focused use case, live BigQuery data, and <1,000 users, Posit is viable.
...
**Your Assessment Context:** If your assessment shows need for fast deployment without approvals, custom requirements, and team has IT ops experience, self-hosted is viable.
...
**Your Assessment Context:** If your assessment shows 50K+ users, BigQuery data requirements, and strategic importance, WM Internal is the right long-term choice despite timeline.
...
**Your Assessment Context:** If your assessment shows store-level user base with 50K+ users, pair with MyWM Experiments as the frontend.
...
**Alternative Path:** If user prefers MyWalmart Notes but has time constraints: "MyWalmart Notes has slower development velocity. Here are faster platforms that could meet your needs: [point to MyWM Experiments or Power Apps]"

**Your Assessment Context:** If your assessment shows documentation-focused use case with flexible timeline, MyWalmart Notes is appropriate.
...
**Your Assessment Context:** If your assessment shows market manager audience only (no store-level reach needed), Me@Campus is appropriate.
...
**Your Assessment Context:** If your assessment shows workflow/business process needs with Microsoft integration, Power Apps is appropriate.
...
| MyWalmart Notes + timing | Posit or Experiments | varies | development velocity |

---

## INTEGRATION WITH ASSESSMENT PROCESS

### How Assessment Results Guide Platform Selection

**From Your Assessment Tool Results:**

| Assessment Finding | Platform Decision | Rationale |
|-------------------|------------------|-----------|
| Static content only, no data | Code Puppy Pages | Simplest, lowest cost |
| <1,000 users, R/Python focus | Posit | Analytics-optimized |
| 1,000-5,000 users, live data needed | Self-Hosted or Posit | Depends on team resources |
| 5,000-50,000 users, BigQuery required | Self-Hosted or WM Internal | Need scalability planning |
| 50,000+ users required | WM Internal | Only viable for enterprise scale |
| Store-level reach, 50K+ users | WM Internal + MyWM Experiments | Frontend/backend split |
| Market-only reach, dashboards | Me@Campus | Limited audience scope |
| Business workflows, Microsoft integration | Power Apps | Workflow automation |
...
1. **Complete assessment** using assessment_tool.html or advanced_assessment_tool.html
2. **Review assessment results** for user count, data requirements, timeline
3. **Use decision tree** above to identify 1-2 platform options
4. **Validate with this guide** - review constraints and timelines
5. **Consult with architecture team** - confirm technical feasibility
6. **Include platform decision** in executive proposal
7. **Plan approval process** if needed (SSP, governance, etc.)
