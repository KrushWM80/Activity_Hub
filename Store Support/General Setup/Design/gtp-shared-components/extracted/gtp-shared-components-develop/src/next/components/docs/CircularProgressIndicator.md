...
const Spacer = () => <View style={{height: 8}} />;
 <>
 <CircularProgressIndicator value={50} label={"Test"}/>
  </>
```
...
const CircularProgressIndicatorScreen: React.FC = () => {
  type Traits = {
    color?: string;
    value: number;
    label?: string;
  ...
  const renderCircularProgressIndicator = () => {
    console.log('the traits are: ', traits);
...
CircularProgressIndicatorScreen.displayName = 'CircularProgressIndicatorScreen';
export {CircularProgressIndicatorScreen};
*/
...
const Spacer = () => <View style={{height: 8}} />;
 <>
  <Image
      source={{
        uri: 'https://gecgithub01.walmart.com/storage/user/77503/files/c9e52956-f295-4ee6-8a99-d381dbc74d93',
        height: 800,
        width: 390,
      }}
  />
