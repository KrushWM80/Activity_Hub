...
module.exports = {
  ...
  transformIgnorePatterns: [
    '<rootDir>/node_modules/(?!(react-native|@react-native|@livingdesign|@react-native-community/datetimepicker|@walmart/gtp-shared-components|@walmart/gtp-shared-icons|@react-native-community/picker|@walmart/react-native-logger|@walmart/redux-store|@react-native-firebase|react-native-iphone-x-helper|react-native-gesture-handler|@react-native/polyfills|@react-native/normalize-color|@walmart/ui-components)|@walmart/core-services)',
  ],
