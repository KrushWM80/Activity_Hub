...
SAMPLE_DATA_49_PROJECTS = [
    ...
    {'Initiative - Project Title': 'Authentication System', 'Health Status': 'At Risk', 'Phase': 'Vet', '# of Stores': 60, 'Executive Notes': 'Lisa - Compliance', 'TDA Ownership': 'Dallas POC', 'WM Week': 'WK13', 'Intake & Testing': 'Approval', 'Deployment': 'Hold'},
    # On Track - Project groups by phase (44 total)
]

# Generate 44 On Track projects
for i in range(44):
    phase_list = ['Pending', 'Vet', 'Test', 'Test Markets', 'Roll/Deploy']
