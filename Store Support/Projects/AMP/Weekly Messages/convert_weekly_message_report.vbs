...
For Each objFile In objFiles
    If InStr(objFile.Name, "Weekly Messages Area Reports") > 0 And InStr(objFile.Name, ".csv") > 0 Then
...
If latestFile Is Nothing Then
    WScript.Echo "✗ No Weekly Messages CSV file found"
    WScript.Quit 1
End If
...
WScript.Echo "✓ Weekly Messages report processed successfully at " & Now()
WScript.Quit 0
