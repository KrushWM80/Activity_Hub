...
Automatically creates all required datasets and tables.

Usage:
    python setup_bigquery_tables.py

This script will:
1. Create the Weekly_Message_FY27 dataset (if it doesn't exist)
2. Create the Playbook_Hub_Data dataset (if it doesn't exist)
3. Create 3 tables with proper schema, partitioning, and clustering
"""
...
PARENT_DATASET = "Store_Support_Dev"

# Datasets to create
DATASETS = [
    {
        "dataset_id": "Weekly_Message_FY27",
        "description": "Adobe Analytics Weekly Messages FY27 data",
        "location": "US"
    },
    {
        "dataset_id": "Playbook_Hub_Data",
        "description": "Adobe Analytics Playbook Hub data",
        "location": "US"
    }
]

# Tables to create in Weekly_Message_FY27
WEEKLY_TABLES = [
    {
...
# Tables to create in Playbook_Hub_Data
PLAYBOOK_TABLES = [
    {
...
def create_dataset(client: bigquery.Client, dataset_config: dict) -> bool:
