            ...
            .then(data => {
                ...
                if (data.success) {
                    ...
                    breakdown.forEach(function(s) {
                        var isDenied = s.status && (s.status.indexOf('Denied') >= 0 || s.status.indexOf('Expired') >= 0 || s.status === 'Draft - Pending');
                    ...
                    stepStatus(1,
                        ...
                        '<div style="margin-top:8px;font-size:0.85em;color:#6B7280;">Excludes: AMP PR Merchandise, Draft, Denied, Expired</div>' +
                        ...
                        statusRows +
                        '<tr style="border-top:2px solid #1D4ED8;"><td style="padding:5px 0;font-weight:700;">Total (excl. Draft/Denied/Expired)</td><td style="padding-left:12px;font-weight:700;text-align:right;">' + totalExclDenied + '</td></tr>' +
                        '</table>' +
